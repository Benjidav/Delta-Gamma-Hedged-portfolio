#Calibration : Delta-Gamma Hedging
library(numDeriv)
library(pracma)
library(ggplot2)
library("ggpubr")

dataset_heavy = read.csv2("C:\\Users\\benja\\OneDrive\\Documents\\Calibration\\Delta-Gamma Hedging project\\Dataset.csv", header = TRUE)
...
#Evolution of C0 in function of volatility (0-100%)
